...
public class BankServiceTest extends IntentService {
    ...
    private static BankServiceTest service = null;

    public static BankServiceTest getInstance() {
        if (service == null)
            service = new BankServiceTest();
        return service;
    }
    ...
    public static void startActionInsert(Context context, Bank bank) {
        Intent intent = new Intent(context, BankServiceTest.class);
